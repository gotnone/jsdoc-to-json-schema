...
module.exports = function(input, output) {
    ...
    /**
     * Returns if o is an object
     * @param {*} o - some javascript entity
     * @returns {bool} - is o an object
     */
    function isJSDocObj(o) {
        return (o === Object(o))
            && Object.keys(o).some(k => ['files', 'source'].includes(k));
    }

    const obj = isJSDocObj(input)
      ? { ...input, 'no-cache': true } : { files: input, 'no-cache': true };
    return jsdoc2md.getTemplateData(obj).then((comments) => {
